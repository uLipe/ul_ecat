...
| Option | Meaning |
|--------|---------|
| `CONFIG_UL_ECAT` | Enables the module library. |
| `CONFIG_UL_ECAT_MASTER` | Builds the master core (scan, AL queue, DC hooks). Implies `CONFIG_NET_SOCKETS`, `CONFIG_NET_SOCKETS_PACKET`, and basic IPv4/IPv6 stack symbols as needed by typical Ethernet setups. |
